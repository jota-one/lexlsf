<template>
    <div class="p-8">
                ...
                <Column header="Actions" style="width: 80px;">
                    <template #body="slotProps">
                        <div class="flex gap-2">
                            ...
                            <button class="btn btn-xs btn-ghost" title="Supprimer"
        ...
        <!-- Modal d'édition -->
        <HandConfigurationEditModal v-if="editedHandConfig?.id" v-model="showEditModal" :id="editedHandConfig?.id"
            @saved="loadHandConfigurations" />
        <!-- Modal de confirmation suppression -->
        <ConfirmModal v-model="showDeleteModal" title="Supprimer la configuration ?" :message="deleteMessage"
