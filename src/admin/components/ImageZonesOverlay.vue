...
const activeLocalRight = ref<string[]>(
  Array.isArray(props.activeZonesRight) ? [...props.activeZonesRight] : [],
)
const activeLocalLeft = ref<string[]>(
  Array.isArray(props.activeZonesLeft) ? [...props.activeZonesLeft] : [],
)
...
watch(
  () => props.activeZonesRight,
  v => {
    activeLocalRight.value = [...(v || [])]
  },
)
watch(
  () => props.activeZonesLeft,
  v => {
