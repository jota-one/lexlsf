<template>
  <Dialog
    ...
    modal
    :header="
      configurationId ? 'Modifier une configuration de main' : 'Ajouter une configuration de main'
    "
    class="w-[60%]"
  >
...
const { addHandConfiguration, updateHandConfiguration, loadHandConfiguration } =
